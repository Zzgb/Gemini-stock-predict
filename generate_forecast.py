...
try:
    ...
    log("google-generativeai 未安装", "WARN")
...
if GEMINI_AVAILABLE and GEMINI_API_KEY:
    ...
    if not GEMINI_API_KEY:
        log("GEMINI_API_KEY 未配置，Gemini 不可用", "WARN")
...
def _update_forecast_for_stock(symbol, now):
    ...
    log(f"{symbol} 预测已更新，准确率: {accuracy}，T+1={future_dates[0]}")
